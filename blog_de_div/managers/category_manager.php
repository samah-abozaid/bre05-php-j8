...
function getCategory(int $categoryId) : array
{
    ...
    $query = $db->prepare("SELECT * FROM categories WHERE categories.id = :id");
...
function getPostsForCategory(int $categoryId) : array
{
    ...
    // remplissez cette fonction pour qu'elle puisse récupérer 
    // tous les articles d'une catégorie 
    // ainsi que les infos de leur image
